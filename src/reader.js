...
function setEventListeners() {
	if (!listenersExist) {
		...
		const divStatus = document.getElementById("statuslabel");
...
function saveSettings() {
	...
	const newFont = document.getElementById('fontselection').value;
	...
	const newAutoStartSeconds = document.getElementById('autostartseconds').value;
	const newAutoStart = document.getElementById('autostart').checked;
	const newAutoCloseReader = document.getElementById('autoclosereader').checked;
	...
	// Text orientation
	const newtextOrientationIsRightToLeft = document.getElementById('wordrighttoleft').checked;
	...
	const newtextOrientationAutoDetect = document.getElementById('autotextorientation').checked;
	...
	//Display
	const newShowRemainingTime = document.getElementById('showremainingtime').checked;
...
function saveAdvancedSettings() {
	...
	const newPauseCommaDelay = document.getElementById('pausecommadelay').value;
	const newPausePeriodDelay = document.getElementById('pauseperioddelay').value;
	const newPauseParagraphDelay = document.getElementById('pauseparagraphdelay').value;
	const newWordFlickerPercent = document.getElementById('wordflickerpercent').value;

	const newPauseComma = document.getElementById('pausecomma').checked;
	const newPausePeriod = document.getElementById('pauseperiod').checked;
	const newPauseParagraph = document.getElementById('pauseparagraph').checked;
	const newWordFlicker = document.getElementById('wordflicker').checked;
	...
	// Display parameters
	const newTextPosition = document.getElementById('textposition').value;
